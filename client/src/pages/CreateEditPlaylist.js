  ...
  return (
    <div>
        <div className='flex items-center gap-5'>
           <i class="ri-arrow-left-line text-3xl" onClick={()=>{
              navigate('/');
           }}></i>
           <h className="text-3xl">Create Playlist</h>
        </div>
        <div className='flex justify-between gap-3 mt-5'>
           <input className='w-96 ' type='text' placeholder='name' value={name} disabled={selectedPlaylistForEdit} onChange={(e)=>{
        ...
        <div className='grid grid-cols-3 gap-3'>
           {allSongs.map((song,index)=>{
              ...
              return <div 
                className={` p-2 flex items-center shadow rounded border border-gray-300 justify-between cursor-pointer ${
